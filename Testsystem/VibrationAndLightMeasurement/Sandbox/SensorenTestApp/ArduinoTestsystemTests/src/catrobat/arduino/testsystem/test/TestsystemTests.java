package catrobat.arduino.testsystem.test;

import catrobat.arduino.testsystem.ArduinoTestsystem;
...
public class TestsystemTests extends
		ActivityInstrumentationTestCase2<ArduinoTestsystem> {
    ...
    private ArduinoTestsystem mActivity;
     ...
     */
    public TestsystemTests() {

        super("com.android.example.spinner", ArduinoTestsystem.class);
    }
    ...
    public void testSpinnerUI() {
        ...
        TextView resultView =
                (TextView) mActivity.findViewById(catrobat.arduino.testsystem.R.id.SpinnerResult);
