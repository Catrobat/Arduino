...
package catrobat.arduino.testsystem;

import catrobat.arduino.testsystem.R;
 ...
 */
public class ArduinoTestsystem extends Activity {

	/**
	 * GADEI Defs
	 */
	
	//Status text view strings
	private final String STATUS_TEXTVIEW_STRING_NO_ACTION = "Nothing to do!";
	private final String STATUS_TEXTVIEW_STRING_TESTING = "Running Tests! Please wait!";
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         * GADEI code section
         */
        ((TextView)findViewById(R.id.TestStatusTextView)).setText(STATUS_TEXTVIEW_STRING_NO_ACTION);
        
        
        final Button button = (Button) findViewById(R.id.startTestButton);
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                
            	((TextView)findViewById(R.id.TestStatusTextView)).setText(STATUS_TEXTVIEW_STRING_TESTING);
    ...
    public class myOnItemSelectedListener implements OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> parent, View v, int pos, long row) {
            ...
            ArduinoTestsystem.this.mPos = pos;
            ArduinoTestsystem.this.mSelection = parent.getItemAtPosition(pos).toString();
            /*
             * Set the value of the text field in the UI
             */
            TextView resultText = (TextView)findViewById(R.id.SpinnerResult);
            resultText.setText(ArduinoTestsystem.this.mSelection);
        }
    ...
    public boolean readInstanceState(Context c) {
         ...
         */
        this.mPos = p.getInt(POSITION_KEY, ArduinoTestsystem.DEFAULT_POSITION);
    ...
    public boolean writeInstanceState(Context c) {
        ...
        SharedPreferences p =
                c.getSharedPreferences(ArduinoTestsystem.PREFERENCES_FILE, MODE_WORLD_READABLE);
